...
# sql connector
connection = pymysql.connect(host='localhost',user='root',password='aryanjuyal37',db='cv')
...
st.set_page_config(
   page_title="Resume Screening and Analyzer",
...
def run():
    ...
    st.sidebar.markdown('''
        ...
        <p>Students <img src="https://counter9.stat.ovh/private/freecounterstat.php?c=t2xghr8ak6lfqt3kgru233378jya38dy" title="Free Counter" Alt="web counter" width="60px"  border="0" /></p>
    ...
    if choice == 'User':
        ...
        if pdf_file is not None:
            with st.spinner('Hang On while we Process this For You...'):
                time.sleep(4)
    ...
    ###### CODE FOR ABOUT PAGE ######
        ...
        st.subheader("**About The Tool - Resume Screening and Analyzer**")
        ...
        <p align="justify">
            ...
            <b>User -</b> <br/>
            In the Side Bar choose option as user and fill the required fields and upload your resume in pdf format.<br/>
          <br/>
            <b>Feedback -</b> <br/>
            A place where user can suggest some feedback about the tool.<br/><br/>
            <b>Admin -</b> <br/>
            For login use <b>admin</b> as username and <b>admin@resume-analyzer</b> as password.<br/>
            It will load all the required things and perform analysis.
        </p><br/><br/>
